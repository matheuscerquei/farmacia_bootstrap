        ...
        <form action="cadastroProduto_action.php" method="post">
            ...
            <div class="mb-2 d-flex col">
                <div class="w-50">
                    ...
                    <!-- Corrigido type="float" para type="number" -->
                    <input type="number" id="precoInput" name="precoInput" step="0.01" min="0.01" class="form-control w-50" required>
                </div>
                <div class="w-50">
                    <label for="quantidadeInput">Quantidade</label>
                    <input type="number" id="quantidadeInput" name="quantidadeInput" step="1" min="1" class="form-control w-50" required>
                </div>
            </div>
            <div class="mb-2 d-flex col">
                <div class="w-50">
                ...
                <div class="w-50">
                    ...
                    <input type="date" id="dataInput" name="dataInput" class="form-control w-50" min="<?php echo date('Y-m-d'); ?>" placeholder="Selecione uma data...">
                </div>
            </div>
